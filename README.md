...
Animator 是基于 `android.support.design.widget.ValueAnimatorCompat`。

The Animator is forked from `android.support.design.widget.ValueAnimatorCompat`.
...
Add Animator as dependency in project `build.gradle`.
